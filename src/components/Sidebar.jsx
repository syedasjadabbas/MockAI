  ...
  return (
    <aside className="fixed inset-y-0 left-0 w-64 glass-panel border-r border-slate-800/40 z-50 flex flex-col">
      ...
      <div className="p-4 border-t border-slate-800/40">
        <button className="flex items-center gap-3 w-full px-4 py-3 text-sm font-medium text-slate-400 hover:text-red-400 hover:bg-red-500/5 rounded-xl transition-all">
